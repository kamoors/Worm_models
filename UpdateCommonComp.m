function [updatedModel, dataTable] = UpdateCommonComp(model,OG_mets, Rxns, newCompartmentName, add_COMMON_EX, lb, ub, COMMON_mets, fix_h)
%UpdateCommonComp 
...
x = erase(table2array(array2table(erase(table2array(OG_mets), "[e]"))), "[c]");
